                ...
                <form action="${pageContext.request.contextPath}/admin/category/edit" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <c:if test="${not empty category.icon}">
                            <img src="${pageContext.request.contextPath}/image?fname=${category.icon}" width="80" height="80" class="mb-2" style="object-fit: cover; border-radius: 5px;">
                        </c:if>
                    ...
                    <div class="mb-3">
                        <label for="icon" class="form-label">Đổi hình ảnh mới (nếu muốn):</label>
